...
class Sonar:
    ...
    def __init__(
        ...
        self._arrete = False
        self.derniere_distance_brute = None
    ...
    def _traiter_distance(self, distance_brute):
        distance_lissee = self._lisseur.lisser_min_max(distance_brute)
        self.derniere_distance_brute = distance_brute
